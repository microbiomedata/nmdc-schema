...
add_date: '2021-03-31'
agrochem_addition:
- lime;1 kg/acre;2022-11-16T16:05:42+0000
air_temp_regm:
- 25 degree Celsius;R2/2018-05-11T14:30/2018-05-11T19:30/P1H30M
al_sat:
  has_raw_value: 0.1 mg/kg
al_sat_meth: https://journaljeai.com/index.php/JEAI/article/view/583
alkalinity:
  has_raw_value: 50 milligram per liter
alkalinity_method: https://wrrc.umass.edu/research/projects/acid-rain-monitoring-project/analysis-method-ph-and-alkalinity
alkyl_diethers:
...
bathroom_count: 50
bedroom_count: 50
biocide_admin_method: xyz
biomass:
- xyz
biosample_categories:
- LTER
- FICUS
biotic_regm: sample inoculated with Rhizobium spp. Culture
...
carb_nitro_ratio: 0.417361111
chem_administration:
- has_raw_value: agar [CHEBI:2509];2018-05-11T20:00Z
chem_mutagen:
- xyz
chem_treat_method: xyz
chloride:
...
cool_syst_id: 50
crop_rotation: yes;R2/2017-01-01/2018-12-31/P6M
cur_land_use: farmstead
cur_vegetation: MIxS doesn't provide any guidance more specific than "text"
cur_vegetation_meth: https://link.springer.com/article/10.1023/A:1011975321668
date_last_rain:
  has_raw_value: '2018-05-11'
density:
...
gravity:
- xyz
growth_facil: Growth chamber [CO_715:0000189]
growth_hormone_regm:
- xyz
...
hcr_pressure: high
hcr_temp: high
heat_sys_deliv_meth: xyz
heat_system_id: 50
heavy_metals:
- mercury;0.09 micrograms per gram
- arsenic;0.09 micrograms per gram
heavy_metals_meth:
...
light_regm: incandescent light;10 lux;450 nanometer
link_addit_analys: https://pubmed.ncbi.nlm.nih.gov/2315679/
link_class_info: https://wisconsindot.gov/Documents/doing-bus/eng-consultants/cnslt-rsrces/geotechmanual/gt-03-03.pdf
link_climate_info: https://www.int-res.com/abstracts/cr/v14/n3/p161-173/
local_class: jicama soil
local_class_meth: https://www.sciencedirect.com/science/article/abs/pii/S0016706105003083
...
petroleum_hydrocarb:
  has_raw_value: 0.05 micromole per liter
ph: 11.22
ph_meth: https://www.epa.gov/sites/production/files/2015-12/documents/9040c.pdf
phaeopigments:
...
pollutants:
- xyz
pool_dna_extracts: yes, 5
porosity: xyz
potassium:
  has_raw_value: 463 milligram per liter
pres_animal_insect: dog;9
pressure:
  has_raw_value: 50 atmosphere
prev_land_use_meth: xyz
prod_start_date:
  has_raw_value: xyz
...
room_vol: xyz
root_med_carbon: xyz
root_med_macronutr: xyz
root_med_micronutr: xyz
root_med_ph:
  has_raw_value: xyz
root_med_regl: xyz
root_med_suppl: xyz
...
salinity_category: halotolerant is an example from the schema, but MIxS doesn't provide
  this slot any more
salinity_meth: PMID:22895776
salt_regm:
- xyz
samp_collec_device: xyz
samp_collec_method: swabbing
samp_loc_corr_rate: xyz
samp_mat_process:
...
shad_dev_water_mold: xyz
sieving: MIxS does not provide an example
size_frac: xyz
size_frac_low:
...
soil_texture_meth: xyz
soil_type: plinthosol [ENVO:00002250]
soil_type_meth: Frederick series
soluble_inorg_mat:
- xyz
...
store_cond: -20 degree Celsius freezer;P2Y10D
subsurface_depth:
  has_raw_value: MIxS does not provide an example
sulfate:
...
tot_org_c_meth: https://www.epa.gov/sites/production/files/2015-12/documents/9060a.pdf
tot_org_carb:
  has_raw_value: 2%
tot_phosp:
...
water_content:
- has_raw_value: MIxS doesn't provide an example 1
- has_raw_value: MIxS doesn't provide an example 2
water_temp_regm:
- xyz
watering_regm:
