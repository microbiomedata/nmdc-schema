...
# Generation date: 2023-01-27T13:39:51
# Schema: NMDC
#
...
slots.massive_study_identifier = Slot(uri=NMDC.massive_study_identifier, name="massive_study_identifier", curie=NMDC.curie('massive_study_identifier'),
                   model_uri=NMDC.massive_study_identifier, domain=None, range=Optional[Union[Union[str, URIorCURIE], List[Union[str, URIorCURIE]]]],
