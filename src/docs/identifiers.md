...
NMDC offers a central identifier minting [endpoint](https://api.dev.microbiomedata.org/docs#/identifiers/mint_ids_ids_mint_post) in order to save data contributors the trouble of hand-crafting `id`s, but it will require an update before it generates `id`s following the pattern specified below.
 ...
 * [project/jsonschema/nmdc.schema.json](project/jsonschema/nmdc.schema.json)
