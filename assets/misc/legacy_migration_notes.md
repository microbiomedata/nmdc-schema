...
4. Create an ssh tunnel from your local computer, through `dtn01.nersc.gov` to the (production) MongoDB on mongo-loadbalancer.nmdc.production. Note that I am recommending tunneling the MongoDB port to local port 27777. Other NMDC people may recommend other ports. `ssh -i ~/.ssh/nersc -L27777:mongo-loadbalancer.nmdc.production.svc.spin.nersc.org:27017 -o ServerAliveInterval=60 <NERSC USERNAME>@dtn01.nersc.gov`
