...
class Migrator(MigratorBase):
    ...
    def check_for_fields(self, biosample: dict) -> dict:
        ...
        removed_slots = [
            ...
            "dna_cont_type", "dna_cont_well", "dna_container_id", "dna_dnase",
            "dna_isolate_meth", "dna_organisms", "dna_project_contact", "dna_samp_id",
            "dna_sample_format", "dna_sample_name", "dna_seq_project", "dna_seq_project_pi",
            "dna_seq_project_name", "dna_volume", "proposal_dna", "dnase_rna",
            "proposal_rna", "rna_absorb1", "rna_absorb2", "rna_collect_site",
            "rna_concentration", "rna_cont_type", "rna_cont_well", "rna_container_id",
            "rna_isolate_meth", "rna_organisms", "rna_project_contact", "rna_samp_id",
            "rna_sample_format", "rna_sample_name", "rna_seq_project", "rna_seq_project_pi",
            "rna_seq_project_name", "rna_volume", "collection_date_inc"
        ]
        for slot in removed_slots:
            if biosample.get(slot, None):
