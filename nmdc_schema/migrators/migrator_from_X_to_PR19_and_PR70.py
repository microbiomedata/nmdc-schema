...
class Migrator(MigratorBase):
    ...
    def fill_instrument_set(self):
        ...
        for instrument in instruments:
            # This is where id will be inserted??
    ...
    def transform_instrument_slot(self, omics_doc: dict):
        ...
        if "instrument_name" in omics_doc:
            ...
            if matches:
                    ...
                    self.logger.info(f"instrument_name in {omics_doc['id']} is {omics_doc['instrument_name']} and will be matched to instrument with name {matches[0]}")
                    for instrument in instruments:
                        if instrument["name"] == matches[0]:
