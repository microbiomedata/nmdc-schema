...
.PHONY: brute-force-clean brute-force-all

brute-force-clean:
	rm -rf local/mongo*.* local/schema_8_1_2.yaml

brute-force-all: brute-force-clean local/mongo_as_nmdc_database_validation1.log local/mongo_as_nmdc_database_validation2.log

local/schema_8_1_2.yaml:
	wget -O $@ https://raw.githubusercontent.com/microbiomedata/nmdc-schema/v8.1.2/nmdc_schema/nmdc_schema_accepting_legacy_ids.yaml
...
local/mongo_as_nmdc_database_rdf_safe1.yaml: local/schema_8_1_2.yaml local/mongo_as_unvalidated_nmdc_database.yaml
	$(RUN) migration-recursion \
		--input-path local/mongo_as_unvalidated_nmdc_database.yaml \
		--migrator-name Migrator_from_8_0_0_to_8_1_0 \
		--output-path local/mongo_as_nmdc_database_rdf_safe1.yaml \
		--salvage-prefix nmdc \
		--schema-path local/schema_8_1_2.yaml

local/mongo_as_nmdc_database_validation1.log: local/schema_8_1_2.yaml local/mongo_as_nmdc_database_rdf_safe1.yaml
	- $(RUN) linkml-validate \
		--schema local/schema_8_1_2.yaml local/mongo_as_nmdc_database_rdf_safe1.yaml > local/mongo_as_nmdc_database_validation1.log

local/mongo_as_nmdc_database_rdf_safe2.yaml: nmdc_schema/nmdc_schema_accepting_legacy_ids.yaml local/mongo_as_nmdc_database_rdf_safe1.yaml
	$(RUN) migration-recursion \
		--input-path local/mongo_as_nmdc_database_rdf_safe1.yaml \
		--migrator-name Migrator_from_8_1_1_to_9_0_0 \
		--output-path local/mongo_as_nmdc_database_rdf_safe2.yaml \
		--salvage-prefix nmdc \
		--schema-path nmdc_schema/nmdc_schema_accepting_legacy_ids.yaml

local/mongo_as_nmdc_database_validation2.log: nmdc_schema/nmdc_schema_accepting_legacy_ids.yaml local/mongo_as_nmdc_database_rdf_safe2.yaml
	- $(RUN) linkml-validate \
		--schema nmdc_schema/nmdc_schema_accepting_legacy_ids.yaml local/mongo_as_nmdc_database_rdf_safe2.yaml > local/mongo_as_nmdc_database_validation1.log
