...
local/Database-interleaved-class-count.tsv: src/data/valid/Database-interleaved-CHEATING.yaml
...
generate-json-collections: src/data/valid/Database-interleaved-CHEATING.yaml
