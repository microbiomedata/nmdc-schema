...
# Generation date: 2022-08-08T15:19:25
...
class ReadBasedAnalysisActivity(WorkflowExecutionActivity):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://microbiomedata/schema/workflow_execution_activity/ReadBasedAnalysisActivity")
